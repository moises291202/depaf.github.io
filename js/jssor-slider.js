(function(h, g, c, j, e, k, f) {
  ...
  h.$JssorSlideshowRunner$ = function(n, s, q, u, z, A) {
    ...
    if (b.Ub() || b.$IsBrowserOpera() || (z && b.$WebKitVersion() < 537))
      h = 16;
    m.call(f);
    l.call(f, -1e7, 1e7);
  };
  var i = (h.$JssorSlider$ = function(q, hc) {
    ...
    var ib = o.$PlayOrientation & 3,
      ...
      I = b.p(
        { $Class: p, $PlayInMode: 1, $PlayOutMode: 1, $HWA: o.$HWA },
    ...
    if (s) {
      var Hb = b.$Device(),
        Y = Hb.Jf;
      if (o.$HWA && (Y || !b.$IsBrowserFireFox() || b.$BrowserVersion() < 53))
        tb = function(a, c, d) {
      ...
      Jb(Z());
      zb();
      o.$ArrowKeyNavigation &&
        b.$AddEvent(g, "keydown", function(a) {
    ...
    f.Fc = function(E) {
      if (!u) {
        ...
        for (var f = 0; f < s; f++) {
          ...
          B[f] = k;
          a.$ActionMode & 1 &&
            b.$AddEvent(k, "click", b.$CreateCallback(j, t, f));
          a.$ActionMode & 2 &&
            b.$AddEvent(k, "mouseover", b.nc(b.$CreateCallback(j, t, f), k));
          y[f] = b.Zb(k);
        }
        u = e;
      }
  ...
  h.$JssorThumbnailNavigator$ = function(g, B) {
    ...
    function A(q, f) {
      ...
      a.$ActionMode & 2 &&
        b.$AddEvent(c, "mouseover", b.nc(b.$CreateCallback(j, i, 1), c));
    }
    h.qc = function(b, e, f) {
      var a = p;
      p = b;
  ...
  h.$JssorCaptionSlideo$ = function(v, i, u, E) {
    ...
    function z(t, u, g) {
      ...
      b.$Each(u, function(i) {
        ...
        var o = { $Easing: j, $OriginalWidth: g.T, $OriginalHeight: g.W },
